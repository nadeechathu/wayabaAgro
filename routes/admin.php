...
Route::prefix('admin')->middleware(['auth'])->group(function () {
    ...
    Route::get('/product/countries/get/{id}', [App\Http\Controllers\Admin\ProductController::class, 'getCountryForId'])->name('products.get.country');
    ...
    Route::get('/product/variants/remove/{id}',[App\Http\Controllers\Admin\VariantController::class, 'removeVariant'])->name('remove_variant');
    ...
    // Route::get('/brand', [App\Http\Controllers\Admin\ProductController::class, 'all_brands'])->name('brands.all');
    ...
    // Route::get('/zones/all_locations',[App\Http\Controllers\Admin\ZoneController::class, 'getLocation'])->name('zones.all_locations');
    // Route::post('/zones/add_locations',[App\Http\Controllers\Admin\ZoneController::class, 'addLocations'])->name('zones.addLocations');
    // Route::post('/zones/edit_zone_location',[App\Http\Controllers\Admin\ZoneController::class, 'updateZoneLocation'])->name('zones.updateZoneLocation');
    // Route::post('/zones/remove_zone_location',[App\Http\Controllers\Admin\ZoneController::class, 'removeLocationZone'])->name('zones.removeLocationZone');
...
// coupon
    ...
    Route::get('/pre_orders/all',[App\Http\Controllers\Admin\OrderController::class, 'viewPreOrders'])->name('orders.preOrders.all');
    Route::post('/remove_pre_order',[App\Http\Controllers\Admin\OrderController::class, 'removePreOrder'])->name('orders.removeBrand');
     
    Route::post('/orders/refund/',[App\Http\Controllers\Admin\OrderController::class, 'storeRefund'])
    ->name('orders.refund');    
