   ...
   <div class="bg-white border-bottom py-3 mb-5">
      <div class="container-fluid d-flex justify-content-between align-items-start align-items-md-center flex-column flex-md-row">
         <nav class="mb-0" aria-label="breadcrumb">
            <h3 class="m-0">Not Reserved Orders</h3>
         </nav>
         <div class="d-flex justify-content-end align-items-center mt-3 mt-md-0">
            <ol class="breadcrumb m-0">
               <li class="breadcrumb-item"><a href="#">Admin</a></li>
               <li class="breadcrumb-item"><a href="#">Orders</a></li>
               <li class="breadcrumb-item active" aria-current="page">Not Reserved</li>
            </ol>
         </div>
      </div>
   </div>
      ...
      <div class="card">
         <div class="card-header">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
               <form action="{{route('orders.status.change.ui')}}" method="get">
                    ...
                    <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           @elseif($order->inventory_status == 2)
                        ...
                        <td>
                           ...
                           @include('admin.orders.components.quick_view')
                            ...
                            @include('admin.orders.components.confirm_manual_reserve')
                        </td>
