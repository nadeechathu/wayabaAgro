  ...
  <div class="modal-dialog" style="max-width:1000px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        Edit Sub Category - {{$sub_category->child_category_name}}
          
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-bs-label="Close"></button>
      </div>
      <form action="{{route('subCategoriesL2.edit')}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
                  ...
                  <div class="col-md-6">
                      ...
                      <div class="mb-3" id="category_for_sub_category">
                          ...
                          <select class="form-control" name="parent_category" id="parent_category" required>
                              @foreach ($all_sub_categories as $cat)
                                @if ($cat->id == $sub_category->category_id)
                                  <option selected value="{{$cat->id}}">{{$cat->sub_category_name}}</option>
                                @else
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="{{'edit-category-name'.$sub_category->id}}" name="category_name" value="{{$sub_category->child_category_name}}" placeholder="Category Name" required>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="{{'edit-category-description'.$sub_category->id}}" name="category_description" value="{{$sub_category->child_category_description}}" placeholder="Category Description" required>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="row">
                            ...
                            Current image<br/>
                                ...
                                <img src="{{asset($sub_category->child_category_image)}}" alt="{{$sub_category->child_category_name}}" style="width:100%"/>
                                @else
                                No image uploaded
                                @endif
                              </div>
