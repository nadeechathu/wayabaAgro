...
<div class="card">
  <div class="container">                  
        <h3>Low Stock Alert - Product Details</h3>
        <hr/>
        ...
        <table id="orders">
            ...
            <tbody>
            @foreach ($details['lowStockInventories'] as $lowStockInventory)
                <tr>
                    <td>
                    {{$lowStockInventory['product']['product_name']}}
                    </td>
                    <td>
                    {{$lowStockInventory['product']['product_code']}}
                    </td>
                    <td>
                    {{$lowStockInventory['master_quantity']}}
                    </td>
                    <td>
                    {{$lowStockInventory['reserved_quantity']}}
                    </td>
                </tr>
            @endforeach
            </tbody>
