...
<div class="card">
  <div class="container">
    ...
    <h3>{{$details['introduction']}}</h3>
        ...
        <h2>Product Inquiry Details</h2><hr/>

        <p>Product Name : <i>{{$details['inquiry']['variant']['variant_name']}}</i></p>
        <p>Product Quantity : <i>{{$details['inquiry']['quantity']}}</i></p>
        <p>Customer Name : <i>{{$details['inquiry']['customer_name']}}</i></p>
        <p>Phone : <i>{{$details['inquiry']['phone']}}</i></p>
        <p>Email : <i>{{$details['inquiry']['email']}}</i></p>
        <p>Country : <i>{{$details['inquiry']['country']['country_name']}}</i></p>
        <p>Address : <i>{{$details['inquiry']['address']}}</i></p>
        <p>Notes : <i>{{$details['inquiry']['notes']}}</i></p>
