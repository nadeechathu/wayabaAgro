...
<div class="card">
  <div class="container">
    ...
    <h3>{{$details['introduction']}}</h3>
        ...
        @if ($details['is_customer'] == 1)
          <p><b>We would like to confirm that your account was created successfully.</b> To start shopping click the link below.</p>
        @else
          <p><b>We would like to confirm that your account was created successfully.</b></p>
        @endif

        @if ($details['is_customer'] == 1)
          <div class="button-div">
             <a href="{{$details['link']}}" target="_blank"> <button class="mail-button">START SHOPPING</button></a>
          </div>
        @endif
