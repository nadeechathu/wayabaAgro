             <form action="{{route('web.user.profileUpdate')}}" method="post">
                 {{csrf_field()}}
             <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-xl-6 col-12">
                          ...
                          <input type="tel" class="form-control input-check" onChange="removeCountryCode('customer-phone')" oninput="this.value = this.value.replace(/[^0-9.+]/g, '').replace(/(\..*)\./g, '$1');" name="phone" id="customer-phone" value="{{$customer->phone}}" placeholder="Phone">
                       </div>
                    </div>
                    ...
                    <fieldset class="scheduler-border my-4 pt-1"">
                        ...
                        <div class="form-group col-12 pt-1">
                         ...
                         <div class="form-group col-12 pt-1">
                            <label for="" class="pb-2 fw-bolder summary-p">New password (leave blank to leave unchanged)
                         ...
                         <div class="form-group col-12 pt-1">
                            <label for="" class="pb-2 fw-bolder summary-p">Confirm new password
