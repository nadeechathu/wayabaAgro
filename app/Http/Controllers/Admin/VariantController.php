...
class VariantController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if ($hasPermission) {
            ...
            $variant->bulk_price = $request->bulk_price;
            $variant->bulk_quantity = $request->bulk_quantity;
    ...
    public function removeVariant($id)
    {
            ...
            $hasPermission = Auth::user()->hasPermission('remove_variant');
    
            if($hasPermission){
    
                try{
                    Variant::where('id',$id)->delete();
                    ProductInventory::where('variant_id',$id)->delete();
                    ProductInventoryHistory::where('variant_id',$id)->delete();
