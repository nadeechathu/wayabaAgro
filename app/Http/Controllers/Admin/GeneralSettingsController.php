...
class GeneralSettingsController extends Controller
{
    ...
    public function siteSettingsUI(){
        ...
        if($hasPermission){
           ...
           return view('admin.settings.site_settings',compact('siteSettings','siteName','siteDescription','siteLogo','facebook_link','instagram_link','twitter_link','youtube_link','currencySymbol','freeShipping','couponsEnabled','lowStockMargin','adminEmail'));
